...
Docker-based local development is also available and serves the Astro dev server on port 4321:
...
- The repository no longer carries the old Jekyll source archive; Astro is the sole live site source.
